// Test numeric style with "compact" option and format strings
...
#refsection(format-citation: fcite.format-citation)[
  ...
  #print-bibliography(format-reference: fref, label-generator: fcite.label-generator.with(format-string: "J{:02}"), sorting: "n")
]
