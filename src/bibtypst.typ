...
#let refsection(
  ...
  /// same citation formatter as in the previous `refsection`. If you do pass `none`
  /// to the first refsection in the document, a dummy citation formatter will be used.
  /// 
  /// -> function | none
